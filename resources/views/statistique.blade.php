    ...
    <script>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.length > 0) {
                        $('#chartZone').show();
                        setTimeout(function() {
                            const objectifNom = getObjectifNom(idObjectif);
                            initChart(data, objectifNom);
                        }, 100);
                    }
        ...
        function ouvrirModale(apprenti) {
            ...
            $.each(apprenti.sessions, function(i, session) {
                ...
                const reussis = $.grep(session.objectifs, function(o) {
                    return o.reussi;
                });
                const echoues = $.grep(session.objectifs, function(o) {
                    return !o.reussi;
                });
                ...
                let $header = $('<div class="session-header">')
                    ...
                    .append($('<span class="session-meta">').text(
                        session.type_drone + ' · ' + session.type_environnement + ' · ' + session
                        .conditions_meteo
                    ));
                ...
                if (reussis.length === 0) {
                    ...
                    $.each(reussis, function(j, o) {
                        $body.append(
                            ...
                            .append($('<span class="quantite">').text(o.quantite_realisee + ' / ' + o
